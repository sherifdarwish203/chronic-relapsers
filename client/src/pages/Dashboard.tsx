...
export default function Dashboard() {
  ...
  const fetchData = useCallback(async () => {
    ...
    try {
      ...
      // will be redirected by interceptor on 401
    } finally {
      setLoading(false);
    }
  }, []);
  ...
  const handleCSVExport = () => {
    ...
    const url = `/api/v1/facilitators/export/csv`;
    // Use fetch to get with auth header then trigger download
            ...
            <div className="bg-white border border-gray-200 rounded-xl p-4 mb-4">
              ...
              <div className="flex items-center justify-between">
                ...
                <button
                  ...
                  className="bg-green-700 text-white text-sm rounded-lg px-4 py-2 hover:bg-green-800"
                >
                  Export CSV
                </button>
              </div>
